  ...
  return (
    <div className="container py-12 flex flex-col items-center animate-fade-in-up">
      <div className="w-full md:w-1/3 bg-white rounded-2xl shadow-xl p-8 space-y-6">
        <h1 className="text-3xl md:text-4xl font-bold text-primary mb-2 text-center">Entrar</h1>
        <form className="space-y-4">
          ...
          <Button size="lg" className="w-full bg-primary hover:bg-primary/90">Entrar</Button>
        </form>
      </div>
    </div>
  )
